...
public class MTDFS2Agent extends ArtificialAgent {
	...
	public static void main(String[] args) {
		...
		//result = Sokoban.playAgentLevel("Easy/level0001.s4jl", new MTDFS2Agent());   //  5 steps required
		//result = Sokoban.playAgentLevel("Easy/level0002.1.s4jl", new MTDFS2Agent()); // 13 steps required
		//result = Sokoban.playAgentLevel("Easy/level0002.2.s4jl", new MTDFS2Agent()); // 25 steps required
		result = Sokoban.playAgentLevel("Easy/level0002.3.s4jl", new MTDFS2Agent()); // 37 steps required
		
		// THIS LEVEL IS BIT TOO MUCH
		//result = Sokoban.playAgentLevel("Easy/level0003.s4jl", new MTDFS2Agent()); // 60 steps required
		
		// HEADLESS == SIMULATED-ONLY GAME
		//result = Sokoban.simAgentLevel("Easy/level0001.s4jl", new MTDFS2Agent());
